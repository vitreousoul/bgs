...
set PYTHON_DIR=%LOCAL_DATA%\include
set PYTHON_RUNTIME=-L%LOCAL_DATA%\vcruntime140.dll
set PYTHON_LIB=%LOCAL_DATA%\libs\python311.lib
set PATH=%PATH%;%LOCAL_DATA%\include;%COMPILER_DIR%
